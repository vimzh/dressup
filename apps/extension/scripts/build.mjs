 ...
 *
 * There is one copy of the code (`shared`) and one copy of everything both
 * manifests agree on (`manifest.base.json`) — the retailer match
 ...
 *   npm run package               also package dist/<target>.zip
 *
